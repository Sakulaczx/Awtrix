...
Public Sub makeSettings
	...
	If File.Exists(File.Combine(File.DirApp,"Apps"),appName&".ax") Then
		...
		If File.Exists(File.Combine(File.DirApp,"Apps"),"Animationlist.txt") Then
			animationList= File.ReadList(File.Combine(File.DirApp,"Apps"),"Animationlist.txt")
		End If
